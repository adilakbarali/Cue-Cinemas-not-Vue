      ...
      <CardGroup>
        ...
        <Card>
          <Card.Body>
            ...
            <Card.Text>
              Glasgow Fort has 2,500 parking spaces which are all FREE including
              a secure multi-storey car park located next to Vue. Car parks will
              remained open but are temporarily closed when they reach full
              capacity.
              <CardImg 
              variant="Bottom"
