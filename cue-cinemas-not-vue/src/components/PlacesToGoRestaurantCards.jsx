    ...
    return (
        ...
        <Card>
          ...
          <Card.Body className="places-card-body">
            <Card.Title className="moviesTitle">Big Bob's Bistro</Card.Title>
        ...
        <Card>
          ...
          <Card.Body className="places-card-body">
            <Card.Title className="moviesTitle">CueNotVue For One or For Two</Card.Title>
            <Card.Text className="card-aboutUs-body">
        ...
        <Card>
          ...
          <Card.Body className="places-card-body">
            <Card.Title className="moviesTitle">Get in my Belly Burgers</Card.Title>
            <Card.Text className="card-aboutUs-body">
